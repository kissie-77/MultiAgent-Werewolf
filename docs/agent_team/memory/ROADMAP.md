...
| 信念驱动 Skill 注入 | ✅ Done | signal 自动标注；发言 + 私密决策前匹配注入 |
...
- [ ] 信念矩阵与 working memory 深度集成（B1/B2 快照已在 decision context；Skill 信念匹配 ✅；私密决策 refresh ✅ 2026-06-02）

## 变更记录

| 日期 | 摘要 |
|------|------|
| 2026-06-02 | InformationHub 私密决策前统一 `_refresh_actor_belief_skills`；见 memory/DESIGN §6.1 |
