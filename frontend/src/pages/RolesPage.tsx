  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 md:py-16 relative">
        ...
        {filteredRoles.map((role) => (
          ...
          >
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="pt-2 border-t border-zinc-900/50 flex justify-between items-center text-[9px] font-mono text-zinc-500 group-hover:text-zinc-300">
                <span className="uppercase">展开完整档案</span>
      ...
      {filteredRoles.length === 0 && (
        <div className="text-center py-16 text-zinc-500 font-mono text-xs uppercase tracking-widest flex flex-col items-center gap-2">
