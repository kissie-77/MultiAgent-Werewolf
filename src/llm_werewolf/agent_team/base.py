...
class LLMAgent(PromptAgentMixin, BaseAgent):
    """Legacy OpenAI-compatible single-call Agent.

    The AgentScope path is the project mainline.  This class is kept as a
    temporary baseline/fallback during the architecture migration.
    """
