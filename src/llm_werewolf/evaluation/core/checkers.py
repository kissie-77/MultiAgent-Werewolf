...
class RoleSkillChecker:
    ...
    _required_fields = {
        ...
        EventType.WHITE_WOLF_KILLED: {"player_id", "target_id"},
        EventType.WOLF_BEAUTY_CHARMED: {"player_id", "target_id"},
        EventType.NIGHTMARE_BLOCKED: {"player_id", "target_id"},
        EventType.GUARDIAN_WOLF_PROTECTED: {"player_id", "target_id"},
        EventType.RAVEN_MARKED: {"player_id", "target_id"},
