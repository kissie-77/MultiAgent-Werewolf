...
from llm_werewolf.evaluation.correctness.checkers import (
    AsyncFlowChecker,
...
from llm_werewolf.evaluation.correctness.metrics import build_summary
from llm_werewolf.evaluation.correctness.models import CheckResult, GameRunResult
from llm_werewolf.evaluation.correctness.recorder import EvaluationRecorder
from llm_werewolf.evaluation.correctness.reporter import EvaluationReporter
from llm_werewolf.evaluation.correctness.scenarios import EvaluationScenario
...
class EvaluationRunner:
    ...
    async def run_scenario(
        ...
        if recorder.events_path.is_file():
